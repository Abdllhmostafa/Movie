...
void main() {
  testWidgets('HomeScreenContent displays loading indicator when state is MovieLoadingState', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('HomeScreenContent displays error message when state is MovieErrorState', (
    WidgetTester tester,
  ) async {
  ...
  testWidgets('HomeScreenContent displays empty state when movies list is empty', (
    WidgetTester tester,
  ) async {
